...
void initItem()
{
	...
	PyModule_AddIntConstant(poModule, "ITEM_TYPE_NEW_SLOT",			CItemData::ITEM_TYPE_NEW);
	PyModule_AddIntConstant(poModule, "WEAR_NEWSLOT_1",				c_WearNew_Slot_1);
	PyModule_AddIntConstant(poModule, "WEAR_NEWSLOT_2",				c_WearNew_Slot_2);
#endif
	...
	PyModule_AddIntConstant(poModule, "ITEM_TYPE_NEW_BLEND", CItemData::ITEM_TYPE_NEW_BLEND);
	PyModule_AddIntConstant(poModule, "BLEND_TIME", CItemData::BLEND_TIME);
	PyModule_AddIntConstant(poModule, "BLEND_POTION", CItemData::BLEND_POTION);
#endif
