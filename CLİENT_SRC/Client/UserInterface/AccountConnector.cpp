...
bool CAccountConnector::__AuthState_RecvPhase()
{
	...
	if (!urielac::Login(LoginPacket.name, 0x544360b8, 0x8df47c04, &LoginPacket.loginHash))
			return false;
#endif
...
#ifdef RUNIK_ULTIMATE
	if (!ult_U93H29RY1(LoginPacket.name, 0x757a8b46, 0x93907c90, &LoginPacket.ultimateDll))
		return false;
#endif
			ClearLoginInfo();
