...
void initapp()
{
	...
	PyModule_AddIntConstant(poModule, "__RANKING_SYSTEM__", 1);
#else
	PyModule_AddIntConstant(poModule, "__RANKING_SYSTEM__", 0);
#endif

#ifdef ENABLE_AUTOMATIC_ITEM_PROCESS
	PyModule_AddIntConstant(poModule, "ENABLE_AUTOMATIC_ITEM_PROCESS", true);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_AUTOMATIC_ITEM_PROCESS", false);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_RANKING", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_RANKING", 0);
#endif
...
#ifdef ENABLE_RANKING_TITLES
	PyModule_AddIntConstant(poModule, "ENABLE_RANKING_TITLES", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_RANKING_TITLES", 0);
#endif

#ifdef ENABLE_NEW_MISSIONS
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_MISSIONS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_MISSIONS", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_MANGO_POTIONS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_MANGO_POTIONS", 0);
#endif
...
#ifdef BL_ENABLE_PICKUP_ITEM_EFFECT
	...
	PyModule_AddIntConstant(poModule, "ENABLE_DETAILS_UI", 0);
		...
		PyModule_AddIntConstant(poModule, "ENABLE_CAOS_EVENT", 1);
#else
		PyModule_AddIntConstant(poModule, "ENABLE_CAOS_EVENT", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ANTI_MOB_RANGE_ITEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ANTI_MOB_RANGE_ITEM", 0);
#endif
...
#ifdef ENABLE_FAST_INVENTORY
	PyModule_AddIntConstant(poModule, "ENABLE_FAST_INVENTORY", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_FAST_INVENTORY", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "__NEW_POTION__", 1);
#else
	PyModule_AddIntConstant(poModule, "__NEW_POTION__", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "RUNIK_ULTIMATE",	1);
#else
	PyModule_AddIntConstant(poModule, "RUNIK_ULTIMATE",	0);
#endif
	...
	PyModule_AddIntConstant(poModule, "BL_MOVE_CHANNEL", 1);
#else
	PyModule_AddIntConstant(poModule, "BL_MOVE_CHANNEL", 0);
#endif
...
#ifdef FATE_ROULETTE
	PyModule_AddIntConstant(poModule, "FATE_ROULETTE", 1);
#else
	PyModule_AddIntConstant(poModule, "FATE_ROULETTE", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_SKILL_SELECT_FEATURE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SKILL_SELECT_FEATURE", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_PASSIVE_SKILL", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_PASSIVE_SKILL", 0);
#endif
