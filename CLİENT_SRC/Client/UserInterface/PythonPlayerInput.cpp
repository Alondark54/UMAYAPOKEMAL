...
void CPythonPlayer::__OnClickActor(CInstanceBase& rkInstMain, DWORD dwPickedActorID, bool isAuto)
{
	...
	if (!urielac::AddInputEvent(dwPickedActorID))
		return;
#endif
...
#ifdef URIEL_ANTI_CHEAT
	urielac::SetMoveEvent((DWORD*)&c_rkPPosPickedGround.x, (DWORD)_ReturnAddress());
#endif
...
{
#ifdef URIEL_ANTI_CHEAT
	urielac::SetReservedMode(MODE_CLICK_ITEM, (DWORD)_ReturnAddress());
#endif
...
{
#ifdef URIEL_ANTI_CHEAT
	urielac::SetReservedMode(MODE_CLICK_ACTOR, (DWORD)_ReturnAddress());
#endif
...
{
#ifdef URIEL_ANTI_CHEAT
	urielac::SetReservedMode(MODE_CLICK_POSITION, (DWORD)_ReturnAddress());
#endif
...
{
#ifdef URIEL_ANTI_CHEAT
	urielac::SetReservedMode(MODE_USE_SKILL, (DWORD)_ReturnAddress());
#endif
...
{
#ifdef URIEL_ANTI_CHEAT
	urielac::ClearInputEvent(m_dwAutoAttackTargetVID);
#endif
...
#ifdef URIEL_ANTI_CHEAT
	if (!urielac::CheckInputEvent(m_dwAutoAttackTargetVID))
		return;
#endif
	if (!pkInstMain->NEW_IsClickableDistanceDestInstance(*pkInstReserved))
	{
#ifdef URIEL_ANTI_CHEAT
	urielac::CheckReturn((DWORD)_ReturnAddress());
#endif
