...
class CMainPacketHeaderMap : public CNetworkPacketHeaderMap
{
	...
	public:
		CMainPacketHeaderMap()
		{
			...
			Set(HEADER_GC_RANKING_UPDATE, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketRank), DYNAMIC_SIZE_PACKET));
#endif
		...
		Set(HEADER_GC_PLAYER_PIN_CODE, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCCharacterPinCode), STATIC_SIZE_PACKET));
			...
			Set(HEADER_GC_LUCKY_DRAW_CURRENT_LD, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCLuckyDrawAddParticipant), STATIC_SIZE_PACKET));
			Set(HEADER_GC_LUCKY_DRAW_ADD_PARTICIPANT, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCLuckyDrawAddParticipant), STATIC_SIZE_PACKET));
#endif
