...
bool SendAttackPacket(UINT uMotAttack, DWORD dwVIDVictim);
		...
		bool SendRefreshOfflineShop(int32_t iDelay = 0);
		bool SendRefreshOfflineShopMoney(int32_t iDelay = 0);
		...
		bool SendOfflineShopCheck(int32_t iDelay = 0);
	...
	public:
		bool RecvLuckyDrawCurrent();
		bool SendLuckyDrawCurrent();
		bool SendLuckyDrawAddParcitipant();
		bool SendLuckyDrawClaimAward();
	protected:
#endif
	...
	public:
		...
		bool SendExtBattlePassComplateMission(BYTE bType, BYTE bBattlePassID, BYTE bMissionIndex);
