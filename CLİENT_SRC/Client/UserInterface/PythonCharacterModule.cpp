...
PyObject * chrMoveToDestPosition(PyObject* poSelf, PyObject* poArgs)
{
	...
	TPixelPosition pos(ix, iy, 0.0f);
	urielac::SetMoveEvent((DWORD*)&pos.x, (DWORD)_ReturnAddress());
	pCharacterInstance->NEW_MoveToDestPixelPositionDirection(pos);
#else
...
void initchr()
{
	...
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_NEW_POTION", CInstanceBase::NEW_AFFECT_NEW_POTION);
#endif
	...
	PyModule_AddIntConstant(poModule, "AFFECT_DBONE5", CInstanceBase::AFFECT_DBONE5);
	PyModule_AddIntConstant(poModule, "AFFECT_DBONE6", CInstanceBase::AFFECT_DBONE6);
#endif
#if defined DBONE_EFFECTS
