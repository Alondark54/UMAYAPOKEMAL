...
class BossTrackingSystemWindow(ui.ScriptWindow):
	...
	def LoadWindow(self):
		...
		self.title_name_4.SetText("Koordinat : X : 1362 Y : 1405")
		self.title_name_5.SetText("Yeniden Doðuþ Süresi : 4saat")
		...
		self.BossTrackingImage.SetPosition(265-49, 95+156)
		self.BossTrackingImage.Show()
		self.BossTrackingImage2 = ui.ExpandedImageBox()
		self.BossTrackingImage2.SetParent(self.board)
		self.BossTrackingImage2.LoadImage("d:/ymir work/patrontakip/buz.tga")
		self.BossTrackingImage2.SetPosition(465-65, 90+0)
		self.BossTrackingImage2.Show()
	...
	def __MenuFunction(self, value):
		if value == 1:
			...
			self.title_name_4.SetText("Koordinat : X : 144 Y : 778")
			self.title_name_5.SetText("Yeniden Doðuþ Süresi : 2saat")
			self.BossTrackingImage = ui.ExpandedImageBox()
			self.BossTrackingImage.SetParent(self.board)
			...
			self.BossTrackingImage2 = ui.ExpandedImageBox()
			self.BossTrackingImage2.SetParent(self.board)
			self.BossTrackingImage2.LoadImage("d:/ymir work/patrontakip/alev.tga")
			self.BossTrackingImage2.SetPosition(465-65, 90+0)
			self.BossTrackingImage2.Show()
			...
			self.title_name_4.SetText("Koordinat : X : 385 Y : 387")
			self.title_name_5.SetText("Yeniden Doðuþ Süresi : 2saat")
			self.BossTrackingImage = ui.ExpandedImageBox()
			self.BossTrackingImage.SetParent(self.board)
			...
			self.BossTrackingImage2 = ui.ExpandedImageBox()
			self.BossTrackingImage2.SetParent(self.board)
			self.BossTrackingImage2.LoadImage("d:/ymir work/patrontakip/orumcek.tga")
			self.BossTrackingImage2.SetPosition(465-65, 90+0)
			self.BossTrackingImage2.Show()
			...
			self.title_name_4.SetText("Koordinat : X : 394 Y : 438")
			self.title_name_5.SetText("Yeniden Doðuþ Süresi : 2saat")
			self.BossTrackingImage = ui.ExpandedImageBox()
			self.BossTrackingImage.SetParent(self.board)
			...
			self.BossTrackingImage2 = ui.ExpandedImageBox()
			self.BossTrackingImage2.SetParent(self.board)
			self.BossTrackingImage2.LoadImage("d:/ymir work/patrontakip/kaplan.tga")
			self.BossTrackingImage2.SetPosition(465-65, 90+0)
			self.BossTrackingImage2.Show()
			...
			self.title_name_4.SetText("Koordinat : X : 777 Y : 833")
			self.title_name_5.SetText("Yeniden Doðuþ Süresi : 20dakika")
			self.BossTrackingImage = ui.ExpandedImageBox()
			self.BossTrackingImage.SetParent(self.board)
			...
			self.BossTrackingImage2 = ui.ExpandedImageBox()
			self.BossTrackingImage2.SetParent(self.board)
			self.BossTrackingImage2.LoadImage("d:/ymir work/patrontakip/ork.tga")
			self.BossTrackingImage2.SetPosition(465-65, 90+0)
			self.BossTrackingImage2.Show()
			...
			self.title_name_4.SetText("Koordinat : X : 755 Y : 629")
			self.title_name_5.SetText("Yeniden Doðuþ Süresi : 30dakika")
			self.BossTrackingImage = ui.ExpandedImageBox()
			self.BossTrackingImage.SetParent(self.board)
			...
			self.BossTrackingImage2 = ui.ExpandedImageBox()
			self.BossTrackingImage2.SetParent(self.board)
			self.BossTrackingImage2.LoadImage("d:/ymir work/patrontakip/kuyruk.tga")
			self.BossTrackingImage2.SetPosition(465-65, 90+0)
			self.BossTrackingImage2.Show()
			...
			self.title_name_4.SetText("Koordinat : X : 874 Y : 621")
			self.title_name_5.SetText("Yeniden Doðuþ Süresi : 20dakika")
			self.BossTrackingImage = ui.ExpandedImageBox()
			self.BossTrackingImage.SetParent(self.board)
			...
			self.BossTrackingImage2 = ui.ExpandedImageBox()
			self.BossTrackingImage2.SetParent(self.board)
			self.BossTrackingImage2.LoadImage("d:/ymir work/patrontakip/kaplumbaga.tga")
			self.BossTrackingImage2.SetPosition(465-65, 90+0)
			self.BossTrackingImage2.Show()
			...
			self.title_name_4.SetText("Koordinat : X : 701 Y : 79")
			self.title_name_5.SetText("Yeniden Doðuþ Süresi : 2,5saat")
			self.BossTrackingImage = ui.ExpandedImageBox()
			self.BossTrackingImage.SetParent(self.board)
			...
			self.BossTrackingImage2 = ui.ExpandedImageBox()
			self.BossTrackingImage2.SetParent(self.board)
			self.BossTrackingImage2.LoadImage("d:/ymir work/patrontakip/agac.tga")
			self.BossTrackingImage2.SetPosition(465-65, 90+0)
			self.BossTrackingImage2.Show()
			...
			self.title_name_3.SetText("Bölge : Sürgün Maðarasý")
			self.title_name_4.SetText("Koordinat : X : 1362 Y : 1405")
			self.title_name_5.SetText("Yeniden Doðuþ Süresi : 1saat")
			self.BossTrackingImage = ui.ExpandedImageBox()
			self.BossTrackingImage.SetParent(self.board)
			...
			self.BossTrackingImage2 = ui.ExpandedImageBox()
			self.BossTrackingImage2.SetParent(self.board)
			self.BossTrackingImage2.LoadImage("d:/ymir work/patrontakip/komutan.tga")
			self.BossTrackingImage2.SetPosition(465-65, 90+0)
			self.BossTrackingImage2.Show()
			...
			self.title_name_3.SetText("Bölge : Hwang Tapýnaðý")
			self.title_name_4.SetText("Koordinat : X : 910 Y : 846")
			self.title_name_5.SetText("Yeniden Doðuþ Süresi : 2saat")
			self.BossTrackingImage = ui.ExpandedImageBox()
			self.BossTrackingImage.SetParent(self.board)
			...
			self.BossTrackingImage2 = ui.ExpandedImageBox()
			self.BossTrackingImage2.SetParent(self.board)
			self.BossTrackingImage2.LoadImage("d:/ymir work/patrontakip/lider.tga")
			self.BossTrackingImage2.SetPosition(465-65, 90+0)
			self.BossTrackingImage2.Show()
