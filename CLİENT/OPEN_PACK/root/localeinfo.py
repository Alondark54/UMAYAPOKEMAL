...
KRALTAG = "%s/effect/kral.mse"	% app.GetLocalePath()
LONCAKRALTAG = "%s/effect/krallonca.mse"	% app.GetLocalePath()
...
#	text = ""
#	if day > 0: text += str(day) + DAY; text += " "
#	if hour > 0: text += str(hour) + HOUR; text += " "
#	if minute > 0: text += str(minute) + MINUTE; text += " "
#	if second > 0: text += str(second) + SECOND
#	return text
...
if app.ENABLE_RANKING_TITLES:
	RANKING_TITLE_LIST = (RANKING_TITLE_1, RANKING_TITLE_2)
