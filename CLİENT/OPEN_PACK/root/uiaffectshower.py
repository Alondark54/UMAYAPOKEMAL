...
class AffectShower(ui.Window):
	...
	AFFECT_DATA_DICT =	{
			...
			MALL_DESC_IDX_START+player.POINT_COSTUME_ATTR_BONUS : (localeInfo.TOOLTIP_MALL_ATTBONUS_STATIC, "icon/item/71028.tga",),
			MALL_DESC_IDX_START+player.POINT_MAGIC_ATT_BONUS_PER : (localeInfo.TOOLTIP_MALL_ATTBONUS_STATIC, "icon/item/71028.tga",),
...
#			MALL_DESC_IDX_START+player.POINT_PC_BANG_DROP_BONUS: (localeInfo.TOOLTIP_MALL_ITEMBONUS_P_STATIC, "d:/ymir work/ui/skill/common/affect/Item_Bonus_p_on.sub",),
	...
	if app.ANTI_MOB_RANGE_ITEM:
		AFFECT_DATA_DICT[561] = ("Okcular Dibinde", "icon/item/paystatus_red.tga")
		AFFECT_DATA_DICT[562] = ("Otomatik Toplama", "icon/item/70002.tga")
		AFFECT_DATA_DICT[WATER_DESC_IDX_START+player.POINT_PENETRATE_PCT] = (localeInfo.TOOLTIP_APPLY_PENETRATE_PCT, 	"d:/ymir work/ui/game/affectshower/50813.sub")
		AFFECT_DATA_DICT[WATER_DESC_IDX_START+player.POINT_CRITICAL_PCT] = (localeInfo.TOOLTIP_APPLY_CRITICAL_PCT, 	"d:/ymir work/ui/game/affectshower/50814.sub")
		AFFECT_DATA_DICT[WATER_DESC_IDX_START+player.ATT_BONUS] = (localeInfo.TOOLTIP_ATT_GRADE, 			"d:/ymir work/ui/game/affectshower/50817.sub")
		AFFECT_DATA_DICT[WATER_DESC_IDX_START+player.DEF_BONUS] = (localeInfo.TOOLTIP_DEF_GRADE, 			"d:/ymir work/ui/game/affectshower/50818.sub")
		AFFECT_DATA_DICT[WATER_DESC_IDX_START+player.RESIST_MAGIC] = (localeInfo.TOOLTIP_MAGIC_DEF_GRADE, 		"d:/ymir work/ui/game/affectshower/50819.sub")
		AFFECT_DATA_DICT[WATER_DESC_IDX_START+player.ATT_SPEED] = (localeInfo.TOOLTIP_ATT_SPEED, 			"d:/ymir work/ui/game/affectshower/50820.sub")
		AFFECT_DATA_DICT[DEW_DESC_IDX_START+player.POINT_CRITICAL_PCT] = (localeInfo.TOOLTIP_APPLY_CRITICAL_PCT, 	"d:/ymir work/ui/game/affectshower/50821.sub")
		AFFECT_DATA_DICT[DEW_DESC_IDX_START+player.POINT_PENETRATE_PCT] = (localeInfo.TOOLTIP_APPLY_PENETRATE_PCT, 	"d:/ymir work/ui/game/affectshower/50822.sub")
		AFFECT_DATA_DICT[DEW_DESC_IDX_START+player.ATT_SPEED] = (localeInfo.TOOLTIP_ATT_SPEED, 			"d:/ymir work/ui/game/affectshower/50823.sub")
		AFFECT_DATA_DICT[DEW_DESC_IDX_START+player.RESIST_MAGIC] = (localeInfo.TOOLTIP_RESIST_MAGIC, 			"d:/ymir work/ui/game/affectshower/50824.sub")
		AFFECT_DATA_DICT[DEW_DESC_IDX_START+player.ATT_BONUS] = (localeInfo.TOOLTIP_ATT_GRADE, 			"d:/ymir work/ui/game/affectshower/50825.sub")
		AFFECT_DATA_DICT[DEW_DESC_IDX_START+player.DEF_BONUS] = (localeInfo.TOOLTIP_DEF_GRADE, 			"d:/ymir work/ui/game/affectshower/50826.sub")
		AFFECT_DATA_DICT[DEW_DESC_IDX_START+player.ENERGY] = (localeInfo.TOOLTIP_ENERGY, 			"d:/ymir work/ui/game/affectshower/51002.sub")
	if app.__NEW_POTION__:
		AFFECT_DATA_DICT[chr.NEW_AFFECT_NEW_POTION + 72031] =  (localeInfo.NEW_AFFECT_NEW_POTION, "icon/item/71028.tga")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_NEW_POTION + 50770] =  (localeInfo.NEW_AFFECT_NEW_POTION, "d:/ymir work/ui/game/affectshower/50821.sub")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_NEW_POTION + 50771] =  (localeInfo.NEW_AFFECT_NEW_POTION, "d:/ymir work/ui/game/affectshower/50822.sub")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_NEW_POTION + 50772] =  (localeInfo.NEW_AFFECT_NEW_POTION, "d:/ymir work/ui/game/affectshower/50823.sub")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_NEW_POTION + 50773] =  (localeInfo.NEW_AFFECT_NEW_POTION, "d:/ymir work/ui/game/affectshower/50824.sub")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_NEW_POTION + 50774] =  (localeInfo.NEW_AFFECT_NEW_POTION, "d:/ymir work/ui/game/affectshower/50825.sub")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_NEW_POTION + 50775] =  (localeInfo.NEW_AFFECT_NEW_POTION, "d:/ymir work/ui/game/affectshower/50826.sub")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_NEW_POTION + 50776] =  (localeInfo.NEW_AFFECT_NEW_POTION, "d:/ymir work/ui/game/affectshower/50821.sub")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_NEW_POTION + 50777] =  (localeInfo.NEW_AFFECT_NEW_POTION, "d:/ymir work/ui/game/affectshower/50822.sub")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_NEW_POTION + 50778] =  (localeInfo.NEW_AFFECT_NEW_POTION, "d:/ymir work/ui/game/affectshower/50823.sub")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_NEW_POTION + 50779] =  (localeInfo.NEW_AFFECT_NEW_POTION, "d:/ymir work/ui/game/affectshower/50824.sub")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_NEW_POTION + 50780] =  (localeInfo.NEW_AFFECT_NEW_POTION, "d:/ymir work/ui/game/affectshower/50825.sub")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_NEW_POTION + 50781] =  (localeInfo.NEW_AFFECT_NEW_POTION, "d:/ymir work/ui/game/affectshower/50826.sub")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_NEW_POTION + 50782] =  (localeInfo.NEW_AFFECT_NEW_POTION, "d:/ymir work/ui/game/affectshower/50813.sub")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_NEW_POTION + 50783] =  (localeInfo.NEW_AFFECT_NEW_POTION, "d:/ymir work/ui/game/affectshower/50814.sub")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_NEW_POTION + 50784] =  (localeInfo.NEW_AFFECT_NEW_POTION, "d:/ymir work/ui/game/affectshower/50815.sub")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_NEW_POTION + 50785] =  (localeInfo.NEW_AFFECT_NEW_POTION, "d:/ymir work/ui/game/affectshower/50816.sub")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_NEW_POTION + 50786] =  (localeInfo.NEW_AFFECT_NEW_POTION, "d:/ymir work/ui/game/affectshower/50817.sub")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_NEW_POTION + 50787] =  (localeInfo.NEW_AFFECT_NEW_POTION, "d:/ymir work/ui/game/affectshower/50818.sub")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_NEW_POTION + 50788] =  (localeInfo.NEW_AFFECT_NEW_POTION, "d:/ymir work/ui/game/affectshower/50819.sub")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_NEW_POTION + 50789] =  (localeInfo.NEW_AFFECT_NEW_POTION, "d:/ymir work/ui/game/affectshower/50820.sub")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_NEW_POTION + 50790] =  (localeInfo.NEW_AFFECT_NEW_POTION, "d:/ymir work/ui/game/affectshower/50813.sub")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_NEW_POTION + 50791] =  (localeInfo.NEW_AFFECT_NEW_POTION, "d:/ymir work/ui/game/affectshower/50813.sub")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_NEW_POTION + 50792] =  (localeInfo.NEW_AFFECT_NEW_POTION, "d:/ymir work/ui/game/affectshower/50813.sub")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_NEW_POTION + 50793] =  (localeInfo.NEW_AFFECT_NEW_POTION, "d:/ymir work/ui/game/affectshower/71045.sub")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_NEW_POTION + 50794] =  (localeInfo.NEW_AFFECT_NEW_POTION, "d:/ymir work/ui/game/affectshower/71044.sub")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_NEW_POTION + 50795] =  (localeInfo.NEW_AFFECT_NEW_POTION, "d:/ymir work/ui/game/affectshower/71030.sub")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_NEW_POTION + 50796] =  (localeInfo.NEW_AFFECT_NEW_POTION, "d:/ymir work/ui/game/affectshower/71028.sub")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_NEW_POTION + 50797] =  (localeInfo.NEW_AFFECT_NEW_POTION, "d:/ymir work/ui/game/affectshower/71029.sub")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_NEW_POTION + 50798] =  (localeInfo.NEW_AFFECT_NEW_POTION, "d:/ymir work/ui/game/affectshower/71027.sub")
