...
class MiniMap(ui.ScriptWindow):
	...
	def __init__(self):
		...
		self.IconA = MapTextToolTip()
		self.IconA.SetText("Oyuncu Siralamasi")
		self.IconA.Show()
		self.IconB = MapTextToolTip()
		self.IconB.SetText("Odul Sistemi")
		self.IconB.Show()
		self.IconC = MapTextToolTip()
		self.IconC.SetText("Sil Sat")
		self.IconC.Show()
		self.IconD = MapTextToolTip()
		self.IconD.SetText("Uzaktan Market")
		self.IconD.Show()
	...
	def __LoadWindow(self):
		...
		try:
			...
			self.__MakeSpecialIconsMinimap()
		except:
			import exception
	...
	def __MakeSpecialIconsMinimap(self):


		minibuton1 = ui.Button()
		minibuton1.SetUpVisual("Sosyal/btn_ranking_normal.tga")
		minibuton1.SetOverVisual("Sosyal/btn_ranking_hover.tga")
		minibuton1.SetDownVisual("Sosyal/btn_ranking_down.tga")
		minibuton1.SetToolTipText("Siralama")
		minibuton1.SetPosition(systemSetting.GetWidth() - 136-5, 45)
		minibuton1.SetEvent(ui.__mem_func__(self.__ClickGlobalRank))
		self.minibuton1 = minibuton1
		self.minibuton1.Show()

		minibuton2 = ui.Button()
		minibuton2.SetUpVisual("Sosyal/btn_battlepass_normal.tga")
		minibuton2.SetOverVisual("Sosyal/btn_battlepass_hover.tga")
		minibuton2.SetDownVisual("Sosyal/btn_battlepass_down.tga")
		minibuton2.SetToolTipText("Odul")
		minibuton2.SetPosition(systemSetting.GetWidth() - 136-5, 70)
		minibuton2.SetEvent(ui.__mem_func__(self.__ClickReward))
		self.minibuton2 = minibuton2
		self.minibuton2.Show()

		minibuton3 = ui.Button()
		minibuton3.SetUpVisual("Sosyal/battle_open_default.tga")
		minibuton3.SetOverVisual("Sosyal/battle_open_over.tga")
		minibuton3.SetDownVisual("Sosyal/battle_open_down.tga")
		minibuton3.SetToolTipText("Biyolog")
		minibuton3.SetPosition(systemSetting.GetWidth() - 136+23, 110)
		minibuton3.SetEvent(ui.__mem_func__(self.__ClickRemoteShop))
		self.minibuton3 = minibuton3
		self.minibuton3.Show()

		minibuton4 = ui.Button()
		minibuton4.SetUpVisual("Sosyal/btn_timer_normal.tga")
	...
	def __ClickReward(self):
		interface = constInfo.GetInterfaceInstance()
		if interface:
			interface.OpenRewardWindow()

	def __ClickRemoteShop(self):
		interface = constInfo.GetInterfaceInstance()
		if interface:
			interface.OpenBiologWindow()

	def __ClickOtoDelete(self):
		interface = constInfo.GetInterfaceInstance()
		if interface:
			interface.OpenItemDeleteWindow()
