...
class TargetBoard(ui.ThinBoard):
	...
	def __init__(self):
		...
		for buttonName in self.BUTTON_NAME_LIST:
			...
			button.SetUpVisual("mango/buttons/button_normal.tga")
			button.SetOverVisual("mango/buttons/button_hover.tga")
			button.SetDownVisual("mango/buttons/button_down.tga")
	...
	def Open(self, vid, name):
		if vid:
			...
			if vid != self.GetTargetVID():
				...
				self.FaceTargetImage.LoadImage("mango/target/circle_bg.png")
				...
				pcRace = chr.GetRaceNumByVID(vid)
				if chr.GetInstanceType(vid) == chr.INSTANCE_TYPE_PLAYER:
					self.FaceTargetImage.Show()
				else:
					self.FaceTargetImage.Hide()

				if pcRace > 8904 :
					self.FaceTargetIcon.LoadImage("mango/target/default.png")
...
#					self.FaceTargetIcon.LoadImage("mango/target/8004.png")
#				elif pcRace == 2036:
#					self.FaceTargetIcon.LoadImage("mango/target/2035.png")
#				elif pcRace >= 131 and pcRace <= 144:
#					self.FaceTargetIcon.LoadImage("mango/target/%d.png" % (pcRace-29))
#				elif pcRace == 8016 or pcRace == 8020 or pcRace == 8026:
#					self.FaceTargetIcon.LoadImage("mango/target/8005.png")
#				elif pcRace == 8017 or pcRace == 8033:
#					self.FaceTargetIcon.LoadImage("mango/target/8006.png")
#				elif pcRace == 8018 or pcRace == 8021  or pcRace == 8027:
#					self.FaceTargetIcon.LoadImage("mango/target/8007.png")
#				elif pcRace == 8019 or pcRace == 8022:
#					self.FaceTargetIcon.LoadImage("mango/target/8008.png")
#				elif pcRace == 8023 or pcRace == 8031:
#					self.FaceTargetIcon.LoadImage("mango/target/8009.png")
#				elif pcRace == 8024:
#					self.FaceTargetIcon.LoadImage("mango/target/8003.png")
#				elif pcRace == 8032:
#					self.FaceTargetIcon.LoadImage("mango/target/8001.png")
#				elif pcRace == 8034:
#					self.FaceTargetIcon.LoadImage("mango/target/8002.png")
#				elif pcRace >= 8035 and pcRace <= 8040:
#					self.FaceTargetIcon.LoadImage("mango/target/%d.png" % (pcRace+16))
#				elif pcRace >= 8041 and pcRace <= 8050:
#					self.FaceTargetIcon.LoadImage("mango/target/8832.png")
#				elif pcRace == 8057:
#					self.FaceTargetIcon.LoadImage("mango/target/8053.png")
#				elif pcRace == 8073:
#					self.FaceTargetIcon.LoadImage("mango/target/8874.png")
#				elif pcRace == 8116:
#					self.FaceTargetIcon.LoadImage("mango/target/8804.png")
#				elif pcRace >= 8101 and pcRace <= 8108:
#					self.FaceTargetIcon.LoadImage("mango/target/%d.png" % (pcRace-100))
#				elif pcRace == 8109 :
#					self.FaceTargetIcon.LoadImage("mango/target/8800.png")
...
#					self.FaceTargetIcon.LoadImage("mango/target/default.png")
#				else :
#					self.FaceTargetIcon.LoadImage("mango/target/%d.png" % pcRace)
