...
class RefineDialogNew(ui.ScriptWindow):
	...
	def __LoadScript(self):
		...
		if app.ENABLE_REFINE_RENEWAL:
			...
			self.checkBox.SetPosition(0, 72)
			...
			self.checkBox.SetTextInfo("Hizli yukseltmek icin tikla")
			self.checkBox.Show()
	...
	if app.ENABLE_REFINE_RENEWAL:
		...
		def OverInItem(self, slotIndex):
			...
			if self.tooltipItem:
				...
				self.tooltipItem.AddItemData(TOOLTIP_DATA['materials'][slot_count][slotIndex])
