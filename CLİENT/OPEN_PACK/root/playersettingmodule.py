...
def __LoadGameEffect():
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+45, "Bip01", localeInfo.KRALTAG)
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+46, "Bip01", localeInfo.LONCAKRALTAG)
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+47, "Bip01", localeInfo.LONCAKRALTAG)
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+48, "Bip01", localeInfo.LONCAKRALTAG)
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+49, "Bip01", localeInfo.LONCAKRALTAG)
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+50, "Bip01", localeInfo.LONCAKRALTAG)
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+51, "Bip01", localeInfo.LONCAKRALTAG)
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+52, "Bip01", localeInfo.LONCAKRALTAG)
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT + 55, 'Bip01 R Hand', 'd:/ymir work/effect/etc/dragonbone.mse')
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT + 54, 'Bip01 L Hand', 'd:/ymir work/effect/etc/dragonbone2.mse')
	...
	if app.ENABLE_ACCE_COSTUME_SYSTEM:
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED + chrmgr.EFFECT_ACCE, "Bip01", "d:/ymir work/pc/common/effect/armor/acc_01.mse")
