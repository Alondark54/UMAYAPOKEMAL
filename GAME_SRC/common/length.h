...
enum EMisc
{
	...
	EXINVENTORY_PAGE_TYPE	= 5,
	EXINVENTORY_MAX_NUM		= EXINVENTORY_PAGE_TYPE * INVENTORY_MAX_NUM,
	EXINVENTORY_POS_START	= INVENTORY_MAX_NUM,
	EXINVENTORY_POS_END		= EXINVENTORY_POS_START + EXINVENTORY_MAX_NUM,
	ABILITY_MAX_NUM			= 50,
	EMPIRE_MAX_NUM			= 4,
	BANWORD_MAX_LEN			= 24,
	SMS_MAX_LEN				= 80,
...
enum EMisc2
{
	DRAGON_SOUL_EQUIP_SLOT_START = EXINVENTORY_POS_END + WEAR_MAX_NUM,
...
typedef struct SItemPos
{
	...
	{
		return ((INVENTORY == window_type || EQUIPMENT == window_type) && cell >= EXINVENTORY_POS_END && cell < EXINVENTORY_POS_END + WEAR_MAX_NUM)
	...
	{
		return INVENTORY == window_type && cell < EXINVENTORY_POS_END;
	}
