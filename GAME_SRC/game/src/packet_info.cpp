...
CPacketInfoCG::CPacketInfoCG()
{
	...
	Set(HEADER_CG_LUCKY_DRAW_ADD_PARTICIPANT, sizeof(TPacketCGLuckyDrawAddParticipant), "LuckyDrawAddParticipant", true);
	Set(HEADER_CG_LUCKY_DRAW_CURRENT_LD, sizeof(TPacketCGLuckyDrawCurrentLD), "LuckyDrawCurrent", true);
	Set(HEADER_CG_LUCKY_DRAW_CLAIM_AWARD, sizeof(TPacketCGLuckyDrawClaimAward), "LuckyDrawClaimAward", true);
#endif
	...
	Set(HEADER_CG_EXT_SEND_BP_COMPLATE_MISSION, sizeof(TPacketCGBattlePassComplateMission), "ReciveExtBattlePassComplateMission", true);
#endif
...
CPacketInfoGG::CPacketInfoGG()
{
...
#ifdef FATE_ROULETTE
	Set(HEADER_GG_FATE_ROULLETTE,				sizeof(TPacketGGFateRoulette), "FateRoulette",false);
#endif
	...
	Set(HEADER_GG_CAOS_EVENT, sizeof(BYTE),			"CaosEvent", false);
#endif
#ifdef ENABLE_NEW_MISSIONS
	Set(HEADER_GG_NEWMISSIONS,					sizeof(TPacketGGNewMissions),			"NewMissions",			false);
	Set(HEADER_GG_NEWMISSIONS_NEW_PLAYER,					sizeof(TPacketGGNewMissionsCharacter),			"NewMissionsCharacter",			false);
	Set(HEADER_GG_GLOBAL_MISSIONS,					sizeof(TPacketGGNewGlobalMissions),			"NewGlobalMissions",			false);
#endif
}
