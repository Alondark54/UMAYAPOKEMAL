...
struct command_info cmd_info[] =
{
...
#ifdef ENABLE_BOT_CONTROL
	{ "b0t_c4tr9", do_bot_control_rof, 	0, POS_DEAD,		GM_PLAYER},
#endif

	{ "respawn",	do_respawn,		0,			POS_DEAD,	GM_WIZARD	},
#ifdef ENABLE_NEW_MISSIONS
	{ "udt_misions",	do_updtmissions,	0,	POS_DEAD,	GM_PLAYER },
#endif
...
#ifdef __RANKING_SYSTEM__
	{ "rank_update",	do_rank_update,		0,		POS_DEAD,	GM_PLAYER },
#endif
	...
	{ "gmefektver",		do_gmefektver,			0,	POS_DEAD,	GM_PLAYER		},
	{ "gmefektverdiger",		do_gmefektverdiger,			0,	POS_DEAD,	GM_PLAYER		},
	{ "ride",				do_ride,				0,	POS_DEAD,	GM_PLAYER	},
#ifdef FATE_ROULETTE
	{ "fateroulette",		do_fateroulette,		0,			POS_DEAD,		GM_PLAYER		},
#endif
#ifdef ENABLE_MULTI_FARM_BLOCK
...
#ifdef ENABLE_GIVE_BASIC_ITEM
	{ "basic_item_old",							do_basic_item_old,					0,		POS_DEAD,	GM_PLAYER	},
#endif
#ifdef WJ_ELDER_ATTRIBUTE_SYSTEM
	{ "add_new_attribute",		do_add_new_attribute,		0,	POS_DEAD,	GM_PLAYER	},
#endif
#ifdef ENABLE_BOSS_TRACKING
	{ "bosstrackingtest",	do_bosstracking,	0,			POS_DEAD,	GM_PLAYER	},
#endif
#ifdef ENABLE_NEWSTUFF
	//item
...
#endif
	{ "chatbot",			do_chatBot,					0,			POS_DEAD,	GM_IMPLEMENTOR	},
#ifdef __OFFLINE_PRIVATE_SHOP_SYSTEM__
	...
	{ "check_offlineshop_open", do_check_offlineshop_open, 0, POS_DEAD, GM_PLAYER },
#endif
#ifdef ENABLE_CAOS_EVENT
	{ "caos_event",	do_caos_event,	0,	POS_DEAD,	GM_IMPLEMENTOR },
	{ "warp_caosevent",	do_warp_caosevent,	0,	POS_DEAD,	GM_PLAYER },
#endif
#ifdef ENABLE_SPLIT
...
#endif
#ifdef ENABLE_AUTOMATIC_ITEM_PROCESS
	{ "automatic_item_process", do_automatic_item_process,	0,	POS_DEAD, GM_PLAYER },
#endif
#ifdef SOHBET_DURDUR
	{ "chat_durdur", do_chat_durdur,	0,	POS_DEAD, GM_PLAYER },
#endif
